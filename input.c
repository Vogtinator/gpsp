...
void update_keys()
{
	...
	{
	case TPAD_ARROW_UP:
		touchpad_pressed = 0x00010000; break;
	case TPAD_ARROW_UPRIGHT:
		touchpad_pressed = 0x00050000; break;
	case TPAD_ARROW_RIGHT:
		touchpad_pressed = 0x00040000; break;
	case TPAD_ARROW_RIGHTDOWN:
		touchpad_pressed = 0x00140000; break;
	case TPAD_ARROW_DOWN:
		touchpad_pressed = 0x00100000; break;
	case TPAD_ARROW_DOWNLEFT:
		touchpad_pressed = 0x00500000; break;
	case TPAD_ARROW_LEFT:
		touchpad_pressed = 0x00400000; break;
	case TPAD_ARROW_LEFTUP:
		touchpad_pressed = 0x00410000; break;
	case TPAD_ARROW_CLICK:
		touchpad_pressed = 0x00000002; break;
	default:
		touchpad_pressed = 0x00000000; break;
	}
...
gui_action_type get_gui_input()
{
	...
	if (getnewkey(KEY_MENU) || getnewkey(gamepad_config_map[KEY_MAP_MENU]))
		return CURSOR_EXIT;
	return CURSOR_NONE;
}
...
u32 update_input()
{
	...
	io_registers[REG_P1] = (~gba_buttons) & 0x3FF;
