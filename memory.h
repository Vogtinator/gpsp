...
extern gamepak_swap_entry_type *gamepak_memory_map;
...
#define memory_map_read(index) memory_map[(index)]
#define memory_map_write(index) memory_map[~(index)]
//extern u8 *memory_map_read[8 * 1024];
extern u32 *reg;
//extern u8 *memory_map_write[8 * 1024];

extern u8 read_handlers_ext[];
extern u8 write_handlers_ext[];
extern u8 write_handlers_vram[];
